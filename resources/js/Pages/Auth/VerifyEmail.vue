...
<template>
    <GuestLayout>
        ...
        <div class="mb-4 text-sm text-zinc-600 dark:text-zinc-400">
            Дякуємо за реєстрацію! Перш ніж почати, перевірте свою електронну адресу, натиснувши посилання
            ми щойно надіслали вам електронний лист? Якщо ви не отримали листа, ми з радістю надішлемо вам інший.
        </div>
