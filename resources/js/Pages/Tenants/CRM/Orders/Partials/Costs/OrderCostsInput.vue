...
const OrderCostsTable = defineAsyncComponent(() => import('@/Pages/Tenants/CRM/Orders/Partials/Costs/OrderCostsTable.vue'))
const OrderCostModal = defineAsyncComponent(() => import('@/Pages/Tenants/CRM/Orders/Partials/Costs/OrderCostModal.vue'))
