...
const onSubmit = async () => {
    if (props.item.data.bank.value === 'monobank') {
        if (!props.item.data.account) {
...
const getMonoClientInfo = async () => {
    ...
    monobank.accounts = data.result.accounts.map((item) => {
        return {
            id: item.id,
