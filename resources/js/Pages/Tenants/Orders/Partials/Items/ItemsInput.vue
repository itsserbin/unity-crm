...
import ItemsTable from "@/Pages/Tenants/Orders/Partials/Items/ItemsTable.vue";
import {defineAsyncComponent, reactive} from "vue";

const ItemsModal = defineAsyncComponent(() => import('@/Pages/Tenants/Orders/Partials/Items/ItemsModal.vue'))
