...
<template>
    ...
    <div
        class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-zinc-100 dark:bg-dots-lighter dark:bg-zinc-900 selection:bg-red-500 selection:text-white"
    >
