...
export default function useItem(props) {
    ...
    const linkAttrs = computed(() => {
        const method = props.item.method ? props.item.method : 'GET'
        const as = props.item.method === 'POST' ? 'button' : 'link';
        const href = props.item.href ? props.item.href : 'javascript:'
