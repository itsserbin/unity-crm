...
use App\Http\Requests\Tenants\Options\UserCreateRequest;
use App\Http\Requests\Tenants\Options\UserUpdateRequest;
...
class UsersController extends BaseController
{
     ...
     * @return JsonResponse
     */
    final public function update(int $id, UserUpdateRequest $request): JsonResponse
    {
